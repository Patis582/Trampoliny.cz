...
export function LiberecHeroContent() {
  ...
  return (
    <div className="relative z-10 h-full flex flex-col justify-end px-gutter max-w-container-max mx-auto pb-16 md:pb-24">
      ...
      <h1 className="font-black uppercase leading-none mb-6">
        ...
        <span className="block overflow-hidden">
          <span className="block text-brand-orange" style={{ fontSize: "clamp(48px, 9vw, 128px)", letterSpacing: "-0.04em", lineHeight: 0.92, ...slideIn(360) }}>
            &amp; Kroužky
          </span>
        </span>
      </h1>
